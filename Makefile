...
pkgdatadir = $(datadir)/apertium-hau
pkgincludedir = $(includedir)/apertium-hau
pkglibdir = $(libdir)/apertium-hau
pkglibexecdir = $(libexecdir)/apertium-hau
...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/apertium-hau.pc.in COPYING install-sh missing
...
CONFIG_CLEAN_FILES = apertium-hau.pc
...
am__installdirs = "$(DESTDIR)$(apertium_haudir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_hau_DATA) $(noinst_DATA) $(pkgconfig_DATA)
...
ACLOCAL = ${SHELL} /Users/ethanchi/Documents/apy/apertium-hau/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AUTOCONF = ${SHELL} /Users/ethanchi/Documents/apy/apertium-hau/missing autoconf
AUTOHEADER = ${SHELL} /Users/ethanchi/Documents/apy/apertium-hau/missing autoheader
AUTOMAKE = ${SHELL} /Users/ethanchi/Documents/apy/apertium-hau/missing automake-1.14
AWK = gawk
CGCOMP = /usr/local/bin/cg-comp
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"apertium-hau\" -DPACKAGE_TARNAME=\"apertium-hau\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"apertium-hau\ 0.1.0\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\"
ECHO_C = \c
ECHO_N = 
ECHO_T = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/ethanchi/Documents/apy/apertium-hau/missing makeinfo
MKDIR_P = ./install-sh -c -d
PACKAGE = apertium-hau
PACKAGE_BUGREPORT = 
PACKAGE_NAME = apertium-hau
PACKAGE_STRING = apertium-hau 0.1.0
PACKAGE_TARNAME = apertium-hau
PACKAGE_URL = 
...
STRIP = 
VERSION = 0.1.0
abs_builddir = /Users/ethanchi/Documents/apy/apertium-hau
abs_srcdir = /Users/ethanchi/Documents/apy/apertium-hau
abs_top_builddir = /Users/ethanchi/Documents/apy/apertium-hau
abs_top_srcdir = /Users/ethanchi/Documents/apy/apertium-hau
am__leading_dot = .
...
install_sh = ${SHELL} /Users/ethanchi/Documents/apy/apertium-hau/install-sh
...
$(am__aclocal_m4_deps):
apertium-hau.pc: $(top_builddir)/config.status $(srcdir)/apertium-hau.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_hauDATA: $(apertium_hau_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_hau_DATA)'; test -n "$(apertium_haudir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_haudir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_haudir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_haudir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_haudir)" || exit $$?; \
	done

uninstall-apertium_hauDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_hau_DATA)'; test -n "$(apertium_haudir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_haudir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_haudir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_hauDATA install-data-local \
...
uninstall-am: uninstall-apertium_hauDATA uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_hauDATA install-data \
	...
	uninstall-am uninstall-apertium_hauDATA \
	uninstall-pkgconfigDATA
...
test: all
	echo "TODO test sentence" | apertium -d . hau-morph | tee .test-mt
